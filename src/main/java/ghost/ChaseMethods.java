...
public abstract class ChaseMethods {
    ...
    public static void GhostHitsWaka(Map map, int ghostX, int ghostY, ChaseBehaviour ghost) {

        if ((map.wakaX == ghostX) && (map.wakaY == ghostY) && (map.frightenMode || map.ghostInvisible) ) {
            map.ghostsRemoved.add(map.ghostsListCurrentChase.indexOf(ghost));
            map.wakaKillGhost = true;
        }
        
        else if ((map.wakaX == ghostX) && (map.wakaY == ghostY)) {
            ChaseMethods.restoreGame(map);
        }        
    }
    ...
    public static List<String>  PossibleMovesFrighten( Map map, ChaseBehaviour ghost) {
    ...
    public static void FrightenMove(Map map, String lastMove, ChaseBehaviour ghost) {
        
        List<String> allMoves = ChaseMethods.PossibleMovesFrighten(map, ghost);
